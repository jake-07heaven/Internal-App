            ...
            <table>
                ...
                <?php foreach ($current_issues as $key) {
                   ...
                   else
                   {
                    ...
                    echo "<tr><td class='view-button issue-view-button' id='" . $key->id . "'>" . $key->company . "</td><td>" . date('s/m/y',strtotime($key->date)) . "</td><td>" . $key->service . "</td><td>" . $key->issue . "</td><td>" . $key->priority . "</td><td>" . $key->resolved . "</td><td>" . $key->cause . "</td><td>" . $key->client_feeling . "</td><td>" . $button . "</td></tr>";
                }?>
            </table>
        </div>
        <div class="table">
