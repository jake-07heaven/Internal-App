	...
	<?php $this->load->view('head'); ?>
        ...
        <div class="container">
            ...
            <div class="table-input">
                <table>
                    <tr><td>Company Join Date: <input class="text-input" type="date" name="join_date" id="join_date" value="<?php echo $join_date; ?>"></td><td>Company Spend: <input class="text-input" type="number" name="spend" id="spend" value="<?php echo $spend; ?>"></td><td>Company Cost: <input class="text-input" type="number" name="cost" id="cost" value="<?php echo $cost; ?>"></td><td>Company Profit: <input class="text-input" type="number" name="profit" id="profit" value="<?php echo $profit; ?>"></td><td>Company Potential: <input class="text-input" type="number" name="potential" id="potential" value="<?php echo $potential; ?>"></td></tr>
                    <tr><td>Company Hours: <input class="text-input" type="number" name="hours" id="hours" value="<?php echo $hours; ?>"></td><td>Company Refferals: <input class="text-input" type="number" name="refferals" id="refferals" value="<?php echo $refferals; ?>" ></td><td>Company Success: <input class="text-input" type="number" name="success" id="success" value="<?php echo $success; ?>" ></td><td>Company Amount: <input class="text-input" type="number" name="amount" id="amount" value="<?php echo $amount; ?>" ></td><td>Contact Last Spoken: <input class="text-input" type="date" name="last_contact" id="last_contact" value="<?php echo $last_contact; ?>" ></td></tr>
